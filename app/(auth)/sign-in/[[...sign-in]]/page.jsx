...
//         Prepare smarter, not harder! 🚀 Our AI-powered Mock Interview platform helps you practice, analyze, and improve—so you ace your next interview with confidence! 💡🤖
//         </p>
//       </div>
//     </section>
            ...
            <div className="w-full max-w-md space-y-8 text-center">
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-4 text-center">
                  Welcome from<br/> Anindya & Pragati
                </h2>
...
// CSS remains the same as in previous example